...
-- Aston Martin
('dbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Fernando Alonso', 'Spain', 14, '66666666-6666-6666-6666-666666666666'),
('dcccccc1-cccc-cccc-cccc-cccccccccccc', 'Lance Stroll', 'Canada', 18, '66666666-6666-6666-6666-666666666666'),
-- Racing Bulls
('ddddddd1-dddd-dddd-dddd-dddddddddddd', 'Isack Hadjar', 'Algeria', 25, '77777777-7777-7777-7777-777777777777'),
('deeeeee1-eeee-eeee-eeee-eeeeeeeeeeee', 'Liam Lawson', 'New Zealand', 30, '77777777-7777-7777-7777-777777777777'),
-- Alpine
('dfffff01-ffff-ffff-ffff-ffffffffffff', 'Pierre Gasly', 'France', 10, '88888888-8888-8888-8888-888888888888'),
('dgggggg1-gggg-gggg-gggg-gggggggggggg', 'Franco Colapinto', 'Argentina', 43, '88888888-8888-8888-8888-888888888888'),
('dhhhhh01-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'Jack Doohan', 'Australia', 7, '88888888-8888-8888-8888-888888888888'),
-- Haas
('diiiii01-iiii-iiii-iiii-iiiiiiiiiiii', 'Esteban Ocon', 'France', 31, '99999999-9999-9999-9999-999999999999'),
('djjjjj01-jjjj-jjjj-jjjj-jjjjjjjjjjjj', 'Oliver Bearman', 'United Kingdom', 50, '99999999-9999-9999-9999-999999999999'),
-- Kick Sauber
('dkkkk101-kkkk-kkkk-kkkk-kkkkkkkkkkkk', 'Nico Hülkenberg', 'Germany', 27, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'),
('dlllll01-llll-llll-llll-llllllllllll', 'Gabriel Bortoleto', 'Brazil', 24, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa');
...
('rbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Austrian Grand Prix', 'Spielberg', '🇦🇹', '2025-06-29 13:00:00+00', '15:00', 'completed', 'Lando Norris', 71),
('rcccccc1-cccc-cccc-cccc-cccccccccccc', 'British Grand Prix', 'Silverstone', '🇬🇧', '2025-07-06 14:00:00+00', '15:00', 'completed', 'George Russell', 52),
('rdddddd1-dddd-dddd-dddd-dddddddddddd', 'Belgian Grand Prix', 'Spa-Francorchamps', '🇧🇪', '2025-07-27 13:00:00+00', '15:00', 'completed', 'Lando Norris', 44),
('reeeeee1-eeee-eeee-eeee-eeeeeeeeeeee', 'Hungarian Grand Prix', 'Budapest', '🇭🇺', '2025-08-03 13:00:00+00', '15:00', 'completed', 'George Russell', 70),
('rfffff01-ffff-ffff-ffff-ffffffffffff', 'Dutch Grand Prix', 'Zandvoort', '🇳🇱', '2025-08-31 13:00:00+00', '15:00', 'completed', 'Oscar Piastri', 72),
-- Upcoming races
('rgggggg1-gggg-gggg-gggg-gggggggggggg', 'Italian Grand Prix', 'Monza', '🇮🇹', '2025-09-07 13:00:00+00', '15:00', 'upcoming', NULL, 53),
('rhhhhh01-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'Azerbaijan Grand Prix', 'Baku', '🇦🇿', '2025-09-15 13:00:00+00', '15:00', 'upcoming', NULL, 51),
('riiiiii1-iiii-iiii-iiii-iiiiiiiiiiii', 'Singapore Grand Prix', 'Singapore', '🇸🇬', '2025-09-22 12:00:00+00', '20:00', 'upcoming', NULL, 61),
('rjjjjj01-jjjj-jjjj-jjjj-jjjjjjjjjjjj', 'United States Grand Prix', 'Austin', '🇺🇸', '2025-10-19 19:00:00+00', '14:00', 'upcoming', NULL, 56),
('rkkkkk01-kkkk-kkkk-kkkk-kkkkkkkkkkkk', 'Mexico City Grand Prix', 'Mexico City', '🇲🇽', '2025-10-26 19:00:00+00', '14:00', 'upcoming', NULL, 71),
('rllll101-llll-llll-llll-llllllllllll', 'São Paulo Grand Prix', 'São Paulo', '🇧🇷', '2025-11-02 17:00:00+00', '14:00', 'upcoming', NULL, 71),
('rmmmm101-mmmm-mmmm-mmmm-mmmmmmmmmmmm', 'Las Vegas Grand Prix', 'Las Vegas', '🇺🇸', '2025-11-22 06:00:00+00', '22:00', 'upcoming', NULL, 50),
('rnnnn101-nnnn-nnnn-nnnn-nnnnnnnnnnn', 'Qatar Grand Prix', 'Lusail', '🇶🇦', '2025-11-30 16:00:00+00', '19:00', 'upcoming', NULL, 57),
('roooo101-oooo-oooo-oooo-oooooooooooo', 'Abu Dhabi Grand Prix', 'Yas Marina', '🇦🇪', '2025-12-07 13:00:00+00', '17:00', 'upcoming', NULL, 58);